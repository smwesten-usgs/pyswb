...
from ..constants import __pyswb_root__

varoptions = Union[str, list, tuple]

dims_file = __pyswb_root__ / "static/metadata/dimensions.yaml"
control_file = __pyswb_root__ / "static/metadata/control.yaml"
params_file = __pyswb_root__ / "static/metadata/parameters.yaml"
vars_file = __pyswb_root__ / "static/metadata/variables.yaml"
